...
contract CnsController {
    ...
    modifier onlyByVersionContract() { if (!isVersionContract()) throw; _; }
    modifier onlyByVersionLogic() { if (!isVersionLogic()) throw; _; }
    modifier onlyByVersionContractOrLogic() { if (!isVersionContractOrLogic()) throw; _; }
    ...
    function isVersionContract() constant returns(bool) { return cns.isVersionContract(msg.sender, contractName); }
    function isVersionLogic() constant returns(bool) { return cns.isVersionLogic(msg.sender, contractName); }
